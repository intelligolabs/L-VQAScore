...
L-VQAScore pipeline perform automatic item cropping and VQA-style scoring, with images and corresponding JSON annotation file describing item-attribute pairs. It can be used to evaluate generative model performance.

...
L-VQAScore pipeline perform automatic item cropping and VQA-style scoring, with images and a user-provided JSON annotation file describing item-attribute pair in images.
